...
The PRD files are already in your workspace under `assets/`:
...
Start by understanding the business request. Run the following prompt:
...
[$skill-development] for building a user skill that will help me take PRD-style
...
Requirements:
- Make it a user skill called prd-to-silver
- Put it under /workspace/.snowflake/cortex/skills/
- Start by supporting XLSX, CSV files
```
...
```
Run the skill we just made prd-to-silver
Context:
...
> **What to look for:** A consistent shape you could compare across future PRDs, and a delta plan another engineer could review before deployment. Save this output: `notes/02_prd_change_plan.md`
...
> **What to look for:** Updated SQL, explainable source mapping, explicit assumptions, and validation queries. Save this output: `sql/03_silver_ap_invoices_prd_update.sql`
...
> **What to look for:** A concise handoff package another engineer can review and rerun. Save this output: `notes/03_prd_workflow_handoff.md`
